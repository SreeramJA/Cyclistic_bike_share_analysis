...
- Data timeframe - January 2025 to December 2025
- Source data description
  - The data contains of 12 individual CSV files, each representing one month of trip data.
  - Each file contains trip data and they share consistent column structures.
-	Personally Identifiable Information (PII) were excluded from the dataset, ensuring compliance with privacy standards.
-	After preliminary assessments, the data meets the ROCCC (Reliable, Original, Comprehensive, Current and Cited) standards.
...
## Limitations
-	The dataset does not include demographic data or PII’s, limiting deeper analysis on customer segments.
-	The analysis is based on historical data and does not capture customer motivations behind ride behaviour.
-	The project does not include geographical analysis of the dataset, limiting insights on the geographical aspects of trip data.
